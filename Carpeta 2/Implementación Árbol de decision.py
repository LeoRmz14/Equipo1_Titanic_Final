...
def ArbolDesicion(X_train, X_test, y_train, y_test,Test):
...
for i in range(1,5):
    ...
    for fold in range(5):
        ...
        presicion, Predicciones=ArbolDesicion(X_train, X_test, y_train, y_test,Test)
...
Pred.to_csv("Predicciones Tree.csv",index=False)
